		...
		<form id="filter-form-catalog" name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
            ...
            <div class="filter-block__list">
                ...
                foreach($arResult["ITEMS"] as $key=>$arItem){
                    ...
                    <div class="filter-block__container bx_filter_parameters_box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif?>">

                        <div class="bx_filter_parameters_box_title filter-block__title">
                            <span><?=$arItem["NAME"]?></span>
                            <span class="filter-block__count"></span>
                            <span class="filter-block__arrow"></span>
                        </div>

                        <div class="bx_filter_parameters_box_container filter-block__box">
                            <?
                            ...
                            switch ($arItem["DISPLAY_TYPE"])
                            {
                                ...
                                default://CHECKBOXES
                                    ?>
                                    <?foreach($arItem["VALUES"] as $val => $ar):?>
                                        <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="filter-block__checkbox bx_filter_param_label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
                                            <input
                                                ...
                                                <? echo $ar["CHECKED"]? 'checked="checked"': '' ?>
                                            />
                                            <span class="filter-block__checkbox-fufel">
                                                <span class="filter-block__checkbox-name"><?=$ar["VALUE"];?></span>
                                                <span class="filter-block__checkbox-close"></span>
                                            </span>
                                        </label>
                                    <?endforeach;?>
                            <?
