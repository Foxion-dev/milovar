				...
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-item-block-info">
						...
						<h2 class="basket-item-info-name">
							...
							<span class="basket-item-name" data-entity="basket-item-name">{{NAME}}</span>
...
<!--													</div>-->
            ...
            <td class="basket-items-list-item-scidos">
                <div><span>0%</span></div>
            </td>
<?
        if ($usePriceInAdditionalColumn)
        {
        ?>
        <td class="basket-items-list-item-price-two">
            <div class="basket-item-block-price<?=(!isset($mobileColumns['PRICE']) ? ' d-none d-sm-block' : '')?>">
                {{#SHOW_DISCOUNT_PRICE}}
                <div class="basket-item-price-old">
								<span class="basket-item-price-old-text">
        ...
        <?
			...
			if ($useSumColumn) {
				?>
				<td class="basket-items-list-item-price  basket-items-list-item-price-full <?=(!isset($mobileColumns['SUM']) ? ' d-none d-sm-block' : '')?>">
