;(function() {
	...
	BX.Sale.BasketComponent = {
		...
		init: function(parameters)
		{
			...
			// parameters.result.ITEMS.AnDelCanBuy.forEach(function(item){
			// 	var skuVal = item.PROPERTY_CML2_ATTRIBUTES_VALUE.split(",");
			// 	var skuId = item.PROPERTY_CML2_ATTRIBUTES_VALUE_ID.split(",");
			// 	console.log(skuId, skuVal)
			// })
